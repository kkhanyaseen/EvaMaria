...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In my DataBase, Message <a href=tg://openmessage?user_id=1455323503>Yaseen</a> he will add and then try again')
